...
gnome-terminal --tab -t "image viewer" -- bash -c "source /opt/ros/*/setup.bash; source $HOME/catkin_ws/devel/setup.bash; cd $PROGRAM_PATH; python ros_image_view.py; exec bash"
